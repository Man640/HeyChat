/** HeroUI-style accent presets (Theme Builder palette).
 * IDs match `data-theme-preset` in CSS.
 */
export interface HeroUIThemePreset {
  id:
    | "default"
    | "sky"
    | "lavender"
...
export const HERO_UI_THEME_PRESETS: HeroUIThemePreset[] = [
  {
    id: "default",
    label: "Default",
    swatch:
...
export type HeroUIThemePresetId = HeroUIThemePreset["id"];

export const DEFAULT_THEME_PRESET_ID: HeroUIThemePresetId = "default";
